...
def run_Jonny():
    ...
    if 'who are you' in Command:
        print('My name is Jonny & I am invented by Team Python. The members of team phantom is Md Rehan Ali')
        talk('My name is Jonny & I am invented by Team Python. The members of team phantom is Md Rehan Ali.')
